...
def main(args):
    ...
    #img_list_gt = [i for i in img_list_gt if i.endswith('00.png')]
    ...
    for i, img_path in enumerate(img_list_gt):
        ...
        #img_path_restored = osp.join(args.restored, video_name, basename + args.suffix + ext)
        img_path_restored = osp.join(args.restored, video_name, basename + ext)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/home/psr/PycharmProjects/RASVSR-main/datasets/SAT-MTB-VSR/val2/GT', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/home/psr/PycharmProjects/RASVSR-main/datasets/SAT-MTB-VSR/val2/Bicubic4x', help='Path to restored images')
    parser.add_argument('--crop_border', type=int, default=0, help='Crop border for each side')
    parser.add_argument('--suffix', type=str, default='_test_122_90', help='Suffix for restored images')
    parser.add_argument(
        '--test_y_channel',
        action='store_true',
