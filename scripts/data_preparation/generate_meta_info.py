...
def generate_meta_info_SDMCar(mode='val2'):
    """Generate meta info for val2 dataset.
    """

    gt_folder = '/home/psr/PycharmProjects/RASVSR-main/datasets/SAT-MTB-VSR/val2/GT'
    meta_info_txt = '/home/psr/PycharmProjects/RASVSR-main/basicsr/data/meta_info/meta_info_SDMCar_val2_GT.txt'
